# 875437a0-b36b-4aae-aae4-524bd4283088 implementation handoff

This archive is the source of truth for turning the design into production code. Start from `notmeyet-ios-flow.html`, then preserve the visual system, responsive behavior, and interactions found in the exported files.
...
## Source map
- Primary entry: `notmeyet-ios-flow.html`
...
- A single self-contained `notmeyet-ios-flow.html` is acceptable only when the export truly contains one user-facing screen and its CSS/JS are structured enough to extract tokens, components, states, and behavior.
...
1. Open `notmeyet-ios-flow.html` and `DESIGN-MANIFEST.json`; identify every screen file, launcher/overview file, app module, and interaction before coding.
...
- `assets/notmeyet-user.jpg`
- `picture-svgrepo-com.svg`
- `Screenshot-from-2026-08-03-18-31-51.png`

## Coding checklist for AI tools
1. Inspect `notmeyet-ios-flow.html` and `DESIGN-MANIFEST.json` first and identify reusable components before coding.
