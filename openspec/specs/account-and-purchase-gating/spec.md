# account-and-purchase-gating Specification

## Purpose
Defines service configuration, authentication, routing, paywall, and entitlement rules that gate access to the iOS app.
